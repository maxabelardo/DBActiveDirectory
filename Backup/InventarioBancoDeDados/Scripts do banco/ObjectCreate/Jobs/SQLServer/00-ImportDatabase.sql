...
Titulo: Database (Inserir novas bases)

Objetivo: extrair os meta dados das bases de dados dos servidores de cadastrados na tabelas "[SGBD].[Servidor]".
...
INSERT INTO [SGBD].[BaseDeDados]
           ...
           ,[created])
			...
			inner join [SGBD].[VW_Estancias] AS S ON S.SERVIDOR LIKE '''+ RTRIM(@LinkedEstancia)+'''
