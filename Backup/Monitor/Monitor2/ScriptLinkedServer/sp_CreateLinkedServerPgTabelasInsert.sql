...
'
						...
						--BEGIN
							SET @ExeScript = 'INSERT INTO [SGBD].[SGBDTable]
				([idDatabases]
				,[schema_name]
				,[table_name]
				,[reservedkb]
...
AND T.[schema_name] COLLATE Latin1_General_CI_AS = A.table_schema	
AND T.[table_name]  COLLATE Latin1_General_CI_AS = A.Table_Name)		  '
