...
/****** Object:  Job [02 - MSSQL - Monitoramento [10 em 10 minutos]]    Script Date: 05/07/2021 11:11:32 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 05/07/2021 11:11:32 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Monitoramento de acesso.]    Script Date: 05/07/2021 11:11:32 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [CPU]    Script Date: 05/07/2021 11:11:32 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [RAM]    Script Date: 05/07/2021 11:11:32 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Page life expectancy ( Insert PLE )]    Script Date: 05/07/2021 11:11:32 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Database file IO (insert data file IO)]    Script Date: 05/07/2021 11:11:32 ******/
...
--- Database file IO (insert data file IO)', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Buffe Database]    Script Date: 05/07/2021 11:11:33 ******/
...
--- Database file IO (insert data file IO)', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Verifica se o cluster mudou de nó]    Script Date: 05/07/2021 11:11:33 ******/
