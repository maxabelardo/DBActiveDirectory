...
/****** Object:  Job [01 - MSSQL - Documentação dos Servidores [Diário]]    Script Date: 05/07/2021 11:11:00 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 05/07/2021 11:11:00 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Linked Server validadção]    Script Date: 05/07/2021 11:11:00 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Database (Inserir novas bases)]    Script Date: 05/07/2021 11:11:00 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Database (desativar bases que foram deletadas)]    Script Date: 05/07/2021 11:11:00 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Database (atualização dos dados)]    Script Date: 05/07/2021 11:11:00 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Database Size (Insert size)]    Script Date: 05/07/2021 11:11:00 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Database file (Inserir novos data files)]    Script Date: 05/07/2021 11:11:00 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Database file Size ( insert data file size)]    Script Date: 05/07/2021 11:11:00 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [File Group ( insert dos files groups)]    Script Date: 05/07/2021 11:11:00 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Table (Insert novas tabelas vinculadas as dabases)]    Script Date: 05/07/2021 11:11:00 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Table Index]    Script Date: 05/07/2021 11:11:00 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Table Size (Insert size)]    Script Date: 05/07/2021 11:11:00 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Table index size ( insert index size)]    Script Date: 05/07/2021 11:11:01 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Table index fragmentado (insert de index fragmentado)]    Script Date: 05/07/2021 11:11:01 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Table index mal utilizados (insert index que estão desbanlanciados em sua utilização)]    Script Date: 05/07/2021 11:11:01 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Table Index IO ( Insert leitura e escrita do index)]    Script Date: 05/07/2021 11:11:01 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Table Index Historico ( Insert dos historicos dos index)]    Script Date: 05/07/2021 11:11:01 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Login Servidor (Insert)]    Script Date: 05/07/2021 11:11:02 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Login Servidor (Update)]    Script Date: 05/07/2021 11:11:02 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Login Servidor (Update status)]    Script Date: 05/07/2021 11:11:02 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Permissões nivel da database (Insert)]    Script Date: 05/07/2021 11:11:02 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [HD]    Script Date: 05/07/2021 11:11:02 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Database (Backups executados)]    Script Date: 05/07/2021 11:11:02 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Database [Panel de Backup]]    Script Date: 05/07/2021 11:11:02 ******/
...
ORDER BY AA.Servidor, AA.BasedeDados, AA.[DataExecucao]', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Database [Panel de backup (quadro)]]    Script Date: 05/07/2021 11:11:02 ******/
